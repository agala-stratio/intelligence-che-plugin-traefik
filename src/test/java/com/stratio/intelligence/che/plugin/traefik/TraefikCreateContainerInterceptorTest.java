...
public class TraefikCreateContainerInterceptorTest {
  ...
  private static String TEMPLATE = "predatio.traefik/<serverName>-<machineName>-<workspaceId>";
  ...
  public void testRules() throws Throwable {
    ...
    Assert.assertEquals(
        ...
        "PathPrefixStrip:/wsagent-abcd-work123");
    ...
    Assert.assertEquals(
        ...
        "PathPrefixStrip:/tomcat8-abcd-work123");
